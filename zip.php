...
<body>
    <div class="container">
        ...
        if (isset($_POST['zip_file_name'])) {
            if (!empty($_POST['zip_file_name'])) {
                ...
                if ($result) {
                    echo '<p style="text-align: center;">Successfully Created Zip file ' . $final_name . '. <br><br /> <strong style="color: green;">the zip has been created on same path on this php file</strong></p>';
                } else {
    ...
    <div class="copyright">Copyright &copy; <?php echo date("Y"); ?> . All rights Reserved by<a href="https://appsaeed.github.io" target="_blank">Saeed Hossen</a></div>
